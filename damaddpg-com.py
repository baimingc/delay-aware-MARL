...
#     print( [env.observation_space[0].shape[0] + delay_step*3, env.observation_space[1].shape[0] + delay_step*5])
    replay_buffer = ReplayBuffer(config.buffer_length, maddpg.nagents,
                                 [env.observation_space[0].shape[0] + delay_step*3, env.observation_space[1].shape[0] + delay_step*5],
                                 [acsp.shape[0] if isinstance(acsp, Box) else acsp.n
